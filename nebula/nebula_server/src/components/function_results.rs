...
struct FCList {
    ...
    total_wasm_invocations: usize,
    total_docker_invocations: usize,
    avg_wasm_startup: u128,
    avg_wasm_total_time: u128,
    avg_docker_startup: u128,
...
fn get_fc_list(function_results: Vec<FunctionResult>) -> FCList {
